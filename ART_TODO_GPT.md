...
- ~~**Знаки культа на полу и стене**~~ подключены в 1.74 (`js/decal-pixels.js`, `tools/pack-decals.js`). Было: уже сгенерированы (`output/pixel-ominous-decals-2026-09-23`), их осталось только
  подключить.
