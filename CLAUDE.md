...
24.7 / 42.8 / 65.7 / 96.5 / 109.1 / 141.9 / 153.3 / 163.8, and THE DARK 82.1 beside the fifth (24 Sep
...
**The ramp** (1.66, THE ALTAR, twelve rooms): sentry; one loose clubman; `calmAt` — `CALM_TEMPLATE`,
...
room, placed not rolled); the first brute alone (`introduce` champion at 1); his arena; rest; the ogre.
...
`game.houndSeen()`. No line to the goat, or further than `circle * ringIn` (`* ringOut` once on it,
