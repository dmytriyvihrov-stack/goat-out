...
const CLAIMS = [
  ...
  ['README.md', 'boss blows', `stands a size bigger and takes ${N}`, () => T.boss.hp],
  ...
  ['CONCEPT.md', 'butcher blows', `${N} killing blow, like every man without the outline`, () => T.bearer.hp || 1],
  ...
  ['CONCEPT.md', 'boss hits', `in the ring\\s+absorbs ${N} hits`, () => T.boss.hp],
  ['CONCEPT.md', 'soul on a boss', `amber, takes ${N} more`, () => T.soulBearer.hp],
