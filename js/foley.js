...
const Foley = (() => {
  ...
  const R = {
    ...
    // One of the goat's hooves, running.
    hoof(sr) { return hoof(buf(sr, 0.08), sr, 0, 1); },
  };
  ...
  const LOW = new Set(['boom', 'engine', 'fall', 'scream', 'bleat', 'growl', 'wraith', 'unmade', 'veil', 'card', 'club', 'slow', 'cast', 'rune', 'bell', 'thud', 'roll']);
