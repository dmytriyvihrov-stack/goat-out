...
const Status = {
  ...
  sting(game, e) {
    ...
    if (!stunProof) e.dazed = Math.max(e.dazed, S.stun * game.mods.enemySlow);
  ...
  blast(game, x, y, B, source, green = true) {
    ...
    for (const o of game.enemies) {
      ...
      if (d <= B.hitR * TILE + o.r || o === source) {
        // A heart, but never out of the air: a leap over a drop knocked down is a fall to his death.
        if (o.kind === 'butcher') { o.hp -= 1; o.flash = 0.2; if (o.state !== 'hop') { o.state = 'stagger'; o.timer = 0.4; } if (o.hp <= 0) o.die(game, 'boom', nx, ny); }
